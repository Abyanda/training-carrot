...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; height: 100% !important; margin: 0; padding: 0; width: 100% !important;"
      bgcolor="<?php echo e(config('laravolt.ui.mail.body')); ?>">
...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tbody>
    <tr>
        <td align="center" valign="top" width="100%" bgcolor="<?php echo e(config('laravolt.ui.mail.header')); ?>"
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <tbody>
                <tr>
                    <td align="center" bgcolor="<?php echo e(config('laravolt.ui.mail.content.background')); ?>"
                        ...
                        <div class="header"
                            ...
                            <img src="<?php echo e(config('laravolt.ui.brand_image')); ?>" border="0"
                            ...
                            <h2 style="-moz-osx-font-smoothing: grayscale; -webkit-font-smoothing: antialiased; border: 0; color: <?php echo e(config('laravolt.ui.mail.content.color')); ?>; font: 400 16px/24px apple-system, BlinkMacSystemFont, Arial, 'Segoe UI', 'Helvetica Neue', sans-serif; margin: 0; vertical-align: baseline;"
                                align="center"><?php echo e(config('app.name')); ?></h2>
                        </div>
                    </td>
                </tr>
                </tbody>
                ...
                <tr>
                    <td align="center" valign="top"
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%"
                            ...
                            <tr>
                                <td align="center" bgcolor="<?php echo e(config('laravolt.ui.mail.content.background')); ?>"
                                    style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; border-radius: 0 0 10px 10px; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 25px; color: <?php echo e(config('laravolt.ui.mail.content.color')); ?>">
                                    <?php echo $slot; ?>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <tr>
                    <td align="center" valign="top"
                        ...
                        <p style="font-size: 14px; line-height: 20px;">© <?php echo e(config('app.name')); ?></p>
                    </td>
                </tr>
                </tbody>
            </table>
...
<?php /**PATH /home/wobi/Dokumen/carrot/vendor/laravolt/laravolt/packages/platform/resources/views/mail/body.blade.php ENDPATH**/ ?>